   ...
   @Inject
    ...
    public Response updateApproval(
        ...
        if(approval.isApproval == 1){
            ...
            httpService.SendWhatsapp(ve.no_hp_pic, "Pengajuan Pendaftaran vendor telah di approve dengan nomor "+no_skt+" dan nomor pengajuan "+ve.id_pengajuan);
            httpService.SendWhatsapp(ve.no_hp_direktur, "Pengajuan Pendaftaran vendor telah di approve dengan nomor "+no_skt+"dan nomor pengajuan "+ve.id_pengajuan);
            httpService.sendEmail(ve.email_pic, "Pengajuan Pendaftaran vendor telah di approve dengan nomor "+no_skt+"dan nomor pengajuan "+ve.id_pengajuan, "Approval SKT");
            httpService.sendEmail(ve.email_direktur, "Pengajuan Pendaftaran vendor telah di approve dengan nomor "+no_skt+"dan nomor pengajuan "+ve.id_pengajuan, "Approval SKT");
        }
        if(approval.isApproval == 0){
            ve.catatan = approval.catatan;
            httpService.SendWhatsapp(ve.no_hp_direktur, "Pengajuan pendaftaran vendor anda telah di tolak dengan catatan "+approval.catatan+" ID Pengajuan "+ve.id_pengajuan);
            httpService.sendEmail(ve.email_pic, "Pengajuan pendaftaran vendor anda telah di tolak dengan catatan "+approval.catatan+" ID Pengajuan "+ve.id_pengajuan, "Approval SKT");
        }
