...
@Entity
@Table(name = "checklist_persetujuan_transaksi_proyek")
public class TransaksiProyekDetailPersetujuanEntity extends PanacheEntityBase {
    @Id
    ...
    @JoinColumn(name = "id_pengajuan_transaksi")
    @JsonBackReference
    public TransaksiProyekEntity transaksiPersetujuanProyek;
}
