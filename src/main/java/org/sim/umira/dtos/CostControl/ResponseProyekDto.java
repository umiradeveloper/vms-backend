...
public class ResponseProyekDto<T> {
    ...
    public ResponseProyekDto(BigDecimal total_bk, BigInteger total_pu, BigInteger current_mos, BigInteger kerja_tambah, BigInteger kerja_kurang, BigInteger total_scurve, T proyek) {
